...
public class MiniSatPlus implements SATSolverWithPB {
	...
	/**
	 * Sets the verbosity of the console output generated by MiniSat+. Use 0 for none, 1 for some, 2 for everything.
	 * @requires 0 <= level <= 2
	 * @throws IllegalArgumentException - level < 0 || level > 2 
	 * @effects Sets the verbosity of the console output generated by MiniSat+. 
	 */
	public void setVerbosity(int level) {
		if (level < 0 || level > 2) throw new IllegalArgumentException();
		setVerbosity(minisat, level);
	}
	
	/**
	 * Returns the verbosity level set by the existing instance of MiniSat+: 0 for none, 1 for some, 2 for everything.
	 * @return the verbosity level of MiniSat+.
	 */
	public int getVerbosity() {
		return getVerbosity(minisat);
	}
	 ...
	 * @effects Sets the verbosity of the console output generated by MiniSat+. 
	 */
	private static native void setVerbosity(long minisat, int level);
	
	/**
	 * Returns the verbosity of the console output generated by MiniSat+: 0 for none, 1 for some, 2 for everything.
	 * @return the verbosity level of MiniSat+ corresponding to the first argument.
	 */
	private static native int getVerbosity(long minisat);
}
