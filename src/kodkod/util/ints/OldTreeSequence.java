 ...
 * @author Emina Torlak
 */
final class OldTreeSequence<V> extends AbstractSparseSequence<V> {
	final Entry<V> NIL;
	 ...
	 */
	public OldTreeSequence(SparseSequence<? extends V> s) {
		this();
		putAll(s);
	}
...
//		}
	...
	private abstract class EntryIterator implements Iterator<IndexedEntry<V>> {
		...
		public final void remove() {
			...
			OldTreeSequence.this.remove(lastReturned.index);
