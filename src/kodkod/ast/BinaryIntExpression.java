...
/**
 * A binary integer expression:  a sum or a difference.
...
public final class BinaryIntExpression extends IntExpression {
	...
	/**  
	 * Constructs a new binary int expression: left op right
	 * 
	 * @effects this.left' = left && this.right' = right && this.op' = op
	 * @throws NullPointerException - left = null || right = null || op = null
	 */
	BinaryIntExpression(final IntExpression left, final Operator op, final IntExpression right) {
		this.left = left;
		this.right = right;
		this.op = op;
	...
	/**
	 * Returns true of o is a BinaryIntExpression with the
	...
	/**
	 * Represents a binary integer operator:  plus or minus.
	 */
	public static enum Operator {
		PLUS { 
			public String toString() { return "+"; } 
			int apply(int i0, int i1) { return i0+i1; }
		},
		MINUS { 
			public String toString() { return "-"; }
			int apply(int i0, int i1) { return i0-i1; }
		...
		/**
		 * Returns the result of applying this operator
		 * to the given integers.
		 * @return i0 op i1
		 */
		abstract int apply(int i0, int i1);
	}
